...
3. **Counterpositioning** - how a new upstart's positioning can be difficult for a defender to respond to
4. **Switching Costs** - how making it difficult to switch to a competitor can be an advantage
5. **Branding** - how branding leads to increased willingness to pay, protects your established advantage, builds a moat
